...
function uniNames(graduates){
  const universities = []
  graduates.forEach(graduate => {
    let currentUniversity = graduate.university;
...
function animals(zooAnimals){
  ...
  zooAnimals.forEach(animal => {
    let str = `${animal.scientific_name} ${animal.animal_name}`
...
*/
const animalPop = zooAnimals.reduce(function(accumulator, currentValue){
